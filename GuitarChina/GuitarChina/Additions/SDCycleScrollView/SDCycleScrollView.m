...
@property (nonatomic) UIViewContentMode viewContentMode;
@end
...
- (void)initialization
{
    ...
    _titleLabelBackgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell.hasConfigured) {
        ...
        cell.titleLabelHeight = [UIView calculateLabelHeightWithText:cell.title fontSize:16 width:cell.bounds.size.width - 26];
        cell.titleLabelTextColor = self.titleLabelTextColor;
        cell.titleLabelTextFont = self.titleLabelTextFont;
        cell.hasConfigured = YES;
    }

    cell.imageView.contentMode = self.viewContentMode;
...
{
    self.selectedCell = (SDCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
