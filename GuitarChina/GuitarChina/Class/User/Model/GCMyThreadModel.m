...
- (NSMutableAttributedString *)replyAndViewDetailString {
    if (!_replyAndViewDetailString) {
        ...
        repliesAttachment.image = [[UIImage imageNamed:@"icon_replycount"] imageWithTintColor:[GCColor grayColor2]];
        ...
        viewsAttachment.image = [[UIImage imageNamed:@"icon_watch"] imageWithTintColor:[GCColor grayColor2]];
