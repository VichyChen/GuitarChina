...
- (UITableView *)leftTableView {
    if (!_leftTableView) {
        ...
        _leftTableView.frame = CGRectMake(0, 0, 120, kScreenHeight - kNavigatioinBarHeight - kTabBarHeight);
...
- (UITableView *)rightTableView {
    if (!_rightTableView) {
        ...
        _rightTableView.frame = CGRectMake(self.leftTableView.frame.size.width, 0, kScreenWidth - self.leftTableView.frame.size.width, kScreenHeight - kNavigatioinBarHeight - kTabBarHeight);
